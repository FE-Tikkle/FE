export const REST_API_KEY = import.meta.env.VITE_KAKAO_KEY
export const REDIRECT_URI = 'https://tikkle-dev.netlify.app'
...
export const API_URL = 'https://pqarvqpw3r2kmkosaixg7bdoq40yzcrk.lambda-url.ap-northeast-3.on.aws'
